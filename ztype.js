...
ig.module('game.entities.enemy').requires('impact.entity', 'impact.font', 'game.avenir-next', 'game.entities.explosion').defines(function() {
    EntityEnemy = ig.Entity.extend({
        ...
        currentLetter: 0,
        targeted: false,
        font: new ig.Font('media/fonts/white.png'),
        fontActive: new ig.Font('media/fonts/red.png'),
        speed: 10,
        friction: {
            x: 100,
            y: 100
...
ig.module('game.words.en').defines(function() {
    ig.WORDS = ig.WORDS || {};
    ig.WORDS.EN = {
2: ['не', 'на', 'он', 'то', 'но', 'же', 'вы', 'по', 'да', 'за', 'бы', 'ты', 'от', 'из', 'ее', 'до', 'ну', 'ни', 'ли', 'уж', 'во', 'их', 'мы', 'со', 'ей', 'об', 'ко', 'ах', 'им', 'ка', 'та', 'пр', 'те', 'чт', 'ту', 'го', 'де', 'вс', 'эт', 'мо', 'ра', 'ст', 'ха', 'хе', 'ум', 'се', 'эх', 'гм', 'ме', 'св', 'ль', 'ег', 'пе', 'ва', 'са', 'ве', 'ох', 'бо', 'хо', 'че', 'сл', 'од', 'бе', 'мн', 'ай', 'ею', 'ос', 'ск', 'ви', 'ми', 'ма', 'сп', 'ба', 'ес', 'бу', 'гл', 'що', 'эй', 'ем', 'кр', 'см', 'др', 'лю', 'па', 'ро', 'зн', 'ле', 'як', 'тр', 'жи', 'ел', 'ус', 'фу', 'дв', 'ру', 'ал', 'ой', 'си', 'ду', 'вз', 'ещ', 'хи'],
3: ['что', 'как', 'это', 'все', 'его', 'так', 'она', 'мне', 'еще', 'вот', 'был', 'ему', 'нет', 'уже', 'вас', 'вам', 'или', 'для', 'они', 'тут', 'сам', 'чем', 'раз', 'там', 'где', 'под', 'без', 'ней', 'кто', 'мой', 'ним', 'тем', 'при', 'про', 'нас', 'них', 'мог', 'нее', 'эти', 'тот', 'два', 'том', 'всю', 'над', 'три', 'эту', 'лет', 'нем', 'нам', 'бог', 'вся', 'эта', 'моя', 'мое', 'оно', 'всг', 'пор', 'две', 'наш', 'мои', 'дня', 'тех', 'час', 'дом', 'ибо', 'мою', 'сих', 'нею', 'оба', 'вон', 'той', 'вид', 'год', 'ваш', 'дал', 'сел', 'кое', 'ума', 'сто', 'рад', 'дай', 'обо', 'чай', 'пол', 'рук', 'шел', 'нос', 'дам', 'обе', 'дни', 'сей', 'сон', 'кем', 'муж', 'сын', 'имя', 'жил', 'рот', 'дух', 'сил', 'мир', 'ног', 'уме', 'пан', 'сне', 'ста', 'шею', 'сад', 'чаю', 'изо', 'сво', 'миг', 'век', 'мол', 'пот', 'шум', 'дел', 'дед', 'иди', 'пер', 'лиц', 'сем', 'лес', 'тек', 'шла', 'шаг', 'очи', 'душ', 'суд', 'гор', 'пре', 'тон', 'иду', 'тол', 'лег', 'шли', 'пил', 'зна', 'али', 'ими', 'ком', 'мен', 'рас', 'ухо', 'сию', 'кой', 'уши', 'иль', 'одн', 'бол', 'пос', 'вне', 'буд', 'кот', 'лбу', 'кум', 'аль', 'жду', 'лоб', 'ска', 'сна', 'стр', 'вор', 'шее', 'жив', 'меж', 'гов', 'сие', 'ест', 'лев', 'воз', 'фон', 'мож', 'дру', 'кхи', 'еду', 'себ', 'вел', 'увы', 'жид', 'род', 'теб', 'усы', 'шло', 'пок', 'губ', 'ишь'],
4: ['меня', 'было', 'даже', 'быть', 'если', 'него', 'ведь', 'себя', 'есть', 'была', 'того', 'тебя', 'тебе', 'себе', 'этот', 'были', 'чего', 'один', 'тоже', 'чтоб', 'всех', 'дело', 'знаю', 'надо', 'этом', 'хоть', 'день', 'всем', 'свою', 'весь', 'стал', 'друг', 'иван', 'руки', 'петр', 'хотя', 'руку', 'куда', 'этой', 'лицо', 'таки', 'чуть', 'сама', 'могу', 'нему', 'свои', 'одно', 'свое', 'одна', 'знал', 'тому', 'хочу', 'сами', 'дома', 'буду', 'люди', 'свой', 'мало', 'мной', 'вами', 'кого', 'деле', 'боже', 'моей', 'пред', 'лишь', 'сюда', 'ночь', 'взял', 'брат', 'отец', 'этих', 'этим', 'ваше', 'ними', 'тихо', 'вижу', 'дела', 'одну', 'мере', 'жить', 'пока', 'мать', 'глаз', 'богу', 'пять', 'доме', 'мною', 'едва', 'лица', 'всей', 'бога', 'двух', 'ноги', 'дядя', 'митя', 'черт', 'года', 'отца', 'туда', 'лице', 'стол', 'фома', 'анна', 'души', 'слов', 'чему', 'коли', 'кому', 'идти', 'ясно', 'идет', 'раза', 'свет', 'часа', 'моих', 'виде', 'чрез', 'зато', 'жена', 'окна', 'душу', 'мимо', 'одни', 'имел', 'наши', 'нами', 'илья', 'душе', 'лиза', 'ради', 'ваши', 'душа', 'твой', 'ночи', 'дочь', 'моем', 'коля', 'вниз', 'силы', 'горе', 'хуже', 'ваша', 'утро', 'губы', 'соня', 'жаль', 'пора', 'углу', 'дней', 'виду', 'сего', 'дать', 'трех', 'дети', 'утра', 'ждал', 'убил', 'моим', 'вашу', 'выше', 'роде', 'делу', 'окно', 'воды', 'ушел', 'зная', 'дама', 'твоя', 'дому', 'имею', 'наше', 'ваня', 'вася', 'двор', 'дамы', 'смех', 'этак', 'иной', 'видя', 'граф', 'полу', 'путь', 'руке', 'небо', 'пить', 'дитя', 'слез', 'угол', 'лицу', 'вещи', 'баба', 'наша', 'села', 'твои', 'умер', 'чорт', 'поле', 'катя', 'будь', 'сына', 'мужа', 'ногу', 'рука', 'воду', 'духа', 'стул', 'речь', 'часу', 'рано', 'дали', 'семь', 'чаще', 'беда', 'часы', 'пяти', 'счет', 'верю', 'мире', 'иные', 'крик', 'саду', 'году', 'зубы', 'ужас', 'вера', 'поди', 'язык', 'долг', 'твое', 'само', 'вещь', 'грех', 'рода', 'боль', 'море', 'пьян', 'упал', 'отцу', 'спал', 'прав', 'разу', 'пути', 'тело', 'сила', 'юлия', 'вина', 'воля', 'жили', 'ушла', 'цели', 'дала', 'итак', 'вино', 'уйти', 'горя', 'обед', 'умел', 'жены', 'хлеб', 'даст', 'рада', 'речи', 'сидя', 'щеки', 'точь', 'сижу', 'силу', 'толь', 'знак', 'либо', 'нашу', 'глуп', 'жену', 'мира', 'неба', 'стой', 'горы', 'дуня', 'пору', 'снег', 'дико', 'кофе', 'окну', 'спит', 'проч', 'коль', 'умом', 'воли', 'жила', 'зале', 'цель', 'лесу', 'днем', 'стоя', 'небе', 'бабы', 'взад', 'пуще', 'умею', 'иных', 'снял', 'яков', 'ярко', 'стою', 'идея', 'твою', 'тела', 'худо', 'зина', 'трое', 'залу', 'лука', 'годы', 'двое', 'жене', 'ганя', 'гово', 'живу', 'пото', 'вода', 'перо', 'боли', 'ниже', 'роль', 'тень', 'юлии', 'мама', 'папа', 'план', 'стыд', 'факт', 'шаги', 'удар', 'веру', 'лето', 'мест', 'окон', 'грие', 'едет', 'огня', 'село', 'шагу', 'взяв', 'моря', 'осип', 'родя', 'имея', 'коня', 'леса', 'пере', 'смел', 'тени', 'гроб', 'ждет', 'тише', 'близ', 'мити', 'сухо', 'веры', 'кото', 'лета', 'поля', 'дура', 'дядю', 'смею', 'волю', 'меры', 'стук', 'бить', 'вишь', 'поэт', 'уйду', 'цвет', 'дает', 'живо', 'полк', 'слух', 'суда', 'тепе', 'идут', 'книг', 'бред', 'дяди', 'злой', 'избы', 'ключ', 'сада', 'сказ', 'враг', 'верх', 'всею', 'ложь', 'тако', 'умру', 'безо', 'воде', 'срок', 'шага', 'звук', 'петь', 'сном', 'брал', 'знай'],
5: ['слова,', 'когда', 'вдруг', 'может', 'очень', 'опять', 'потом', 'тогда', 'будто', 'этого', 'чтобы', 'время', 'будет', 'какой', 'почти', 'здесь', 'после', 'глаза', 'всего', 'более', 'можно', 'такой', 'своей', 'князь', 'между', 'много', 'перед', 'точно', 'такое', 'лучше', 'жизнь', 'зачем', 'хотел', 'какая', 'слова', 'через', 'стало', 'давно', 'начал', 'знает', 'жизни', 'разве', 'прямо', 'долго', 'самом', 'думал', 'какие', 'какое', 'назад', 'своим', 'алеша', 'своих', 'нужно', 'одной', 'таким', 'думаю', 'каким', 'людей', 'пошел', 'вовсе', 'слово', 'такие', 'пусть', 'дверь', 'никто', 'такая', 'видел', 'скоро', 'мысль', 'вчера', 'знать', 'право', 'своем', 'любви', 'место', 'одним', 'часто', 'видно', 'кроме', 'стоял', 'голос', 'тобой', 'моего', 'могла', 'вышел', 'люблю', 'скажу', 'стоит', 'свете', 'собою', 'денег', 'домой', 'собой', 'самое', 'франц', 'верно', 'какую', 'самый', 'места', 'помню', 'никак', 'друга', 'стали', 'таких', 'около', 'стала', 'равно', 'ильич', 'месте', 'самой', 'сидел', 'мысли', 'часов', 'вечер', 'слезы', 'рукой', 'любит', 'глядя', 'князя', 'хочет', 'руках', 'этому', 'захар', 'молча', 'город', 'среди', 'моему', 'затем', 'настя', 'любил', 'снова', 'вошел', 'милый', 'всему', 'марья', 'тысяч', 'могли', 'таком', 'всеми', 'иначе', 'узнал', 'скажи', 'утром', 'минут', 'прошу', 'целый', 'самым', 'видом', 'одном', 'такую', 'успел', 'землю', 'павел', 'каких', 'каком', 'лицом', 'народ', 'вашей', 'вздор', 'сидит', 'готов', 'месяц', 'нашей', 'будут', 'груди', 'вслед', 'детей', 'разом', 'боюсь', 'понял', 'встал', 'забыл', 'двери', 'полно', 'самые', 'возле', 'подле', 'могло', 'ночью', 'самых', 'ходил', 'нелли', 'знали', 'вышла', 'ровно', 'улице', 'взять', 'земле', 'ивана', 'пойду', 'честь', 'знала', 'пошла', 'грудь', 'спать', 'везде', 'далее', 'сразу', 'часть', 'будем', 'наших', 'федор', 'шесть', 'своею', 'герой', 'рядом', 'стола', 'пошли', 'ехать', 'конец', 'видал', 'кровь', 'самую', 'также', 'барин', 'ответ', 'ольга', 'шатов', 'столь', 'живет', 'аглая', 'антон', 'улицу', 'ваших', 'слава', 'вверх', 'легко', 'самая', 'дурак', 'читал', 'нашел', 'имеет', 'другу', 'вслух', 'петра', 'велел', 'дворе', 'земли', 'лежал', 'новый', 'нечто', 'могут', 'конца', 'видит', 'домна', 'конце', 'вашим', 'вышло', 'иметь', 'лежит', 'сзади', 'взяла', 'ходит', 'князю', 'столе', 'столу', 'темно', 'решил', 'глава', 'шляпу', 'гости', 'нынче', 'нашем', 'брата', 'вечно', 'робко', 'мужик', 'вновь', 'стану', 'дайте', 'писал', 'права', 'обеда', 'штабс', 'образ', 'делал', 'тобою', 'книги', 'книгу', 'страх', 'стены', 'редко', 'рукою', 'людям', 'сорок', 'твоей', 'ветер', 'вынул', 'мигом', 'замуж', 'менее', 'огонь', 'резко', 'новые', 'выйти', 'приду', 'диван', 'милая', 'двумя', 'ждать', 'света', 'стула', 'хлеба', 'вроде', 'гость', 'любят', 'шагов', 'ничем', 'тоска', 'уехал', 'армии', 'желая', 'желал', 'какою', 'новое', 'ворот', 'даром', 'знают', 'ангел', 'глупо', 'давай', 'улицы', 'ждала', 'крови', 'ближе', 'вышли', 'говор', 'взяли', 'части', 'двора', 'прочь', 'вашем', 'плохо', 'целую', 'важно', 'вошла', 'обоих', 'этими', 'адуев', 'брови', 'семен', 'целые', 'желаю', 'живут', 'фомич', 'верил', 'плечо', 'силах', 'толпа', 'думая', 'спину', 'олеся', 'сверх', 'убить', 'делом', 'евсей', 'зашел', 'слышу', 'новую', 'имени', 'легче', 'мечты', 'стене', 'дождь', 'песни', 'чести', 'внизу', 'найти', 'нигде', 'плечи', 'алешу', 'гостя', 'хорош', 'белые', 'подал', 'таков', 'бежал', 'мадам', 'стихи', 'хотят', 'богом', 'жаром', 'силой', 'стыда', 'толпы', 'вдоль', 'жалко', 'лично', 'немец', 'новой', 'черта', 'верст', 'ивану', 'такою', 'упала', 'берет', 'цветы', 'пишет', 'тарас', 'алеши', 'вошли', 'отцом', 'пойти', 'пошло', 'тоном', 'попал', 'тольк', 'выпил', 'карты', 'отдал', 'роман', 'духом', 'звуки', 'толпе', 'водки', 'войти', 'ждали', 'марфа', 'нашли', 'носом', 'тетка', 'шагах', 'бывал', 'зовут', 'котор', 'молчи', 'софья', 'стоят', 'черты', 'белье', 'одних', 'полка', 'ручку', 'стуле', 'вдали', 'графа', 'грубо', 'земля', 'новых', 'стать', 'врешь', 'ничто', 'новая', 'сошел', 'телом', 'шапку', 'вещей', 'давал', 'ногах', 'пожал', 'слуга', 'белой', 'дурно', 'низко', 'обеих', 'толку', 'числа', 'болен', 'нашим', 'черту', 'алеше', 'добра', 'умный', 'умрет', 'целым', 'лакей', 'макар', 'цвета', 'целая', 'водой', 'волос', 'запах', 'искал', 'малый', 'дошел', 'поеду', 'божий', 'делаю', 'козак', 'нежно', 'ночам', 'связи', 'надел', 'самим', 'тоски', 'книга', 'крест', 'почем', 'ужаса', 'чужой', 'гляди', 'добро', 'имела', 'каков', 'похож', 'губах', 'дрожа', 'знаем', 'играл', 'людях', 'покой', 'сказа', 'всюду', 'дрянь', 'женой', 'коней', 'ходят', 'бежит', 'бреду', 'гляжу', 'делах', 'жадно', 'кусок', 'ловко', 'твоих', 'целью', 'горло', 'смысл', 'умеет', 'имели', 'мужем', 'белый', 'вести', 'летом', 'павла', 'свету', 'толпу', 'левой', 'совет', 'купил', 'тепер', 'чисто', 'болит', 'брать', 'гордо', 'живой', 'нужен', 'берег', 'кухню', 'сесть', 'слухи', 'чашку', 'верит', 'душой', 'закон', 'нужды', 'тоске', 'чужих', 'белом', 'держа', 'звали', 'позор', 'сенях', 'целых', 'белая', 'крики', 'мешок', 'нужна'],
6: ['только', 'теперь', 'сказал', 'нибудь', 'ничего', 'потому', 'совсем', 'всегда', 'хорошо', 'сейчас', 'тотчас', 'другой', 'больше', 'сердце', 'минуту', 'говорю', 'своего', 'именно', 'голову', 'прежде', 'почему', 'иногда', 'знаете', 'нельзя', 'однако', 'вместе', 'правда', 'просто', 'иваныч', 'делать', 'завтра', 'деньги', 'одного', 'самого', 'ужасно', 'знаешь', 'весьма', 'отчего', 'письмо', 'быстро', 'первый', 'любовь', 'такого', 'руками', 'каждый', 'словом', 'старик', 'значит', 'какого', 'вперед', 'рублей', 'должен', 'хотите', 'пришел', 'нечего', 'сделал', 'должно', 'случае', 'вопрос', 'степан', 'хочешь', 'давеча', 'против', 'другое', 'других', 'десять', 'взгляд', 'бывало', 'глазах', 'голова', 'видишь', 'своему', 'сердца', 'другие', 'видеть', 'четыре', 'слышал', 'начала', 'своими', 'вместо', 'сильно', 'кругом', 'минуты', 'вообще', 'голове', 'видите', 'крепко', 'первых', 'оттого', 'увидел', 'нашего', 'всякий', 'хотела', 'далеко', 'узнать', 'матери', 'случай', 'откуда', 'другую', 'любить', 'сударь', 'вашего', 'другом', 'скорее', 'самому', 'насчет', 'можете', 'никого', 'одному', 'дальше', 'вполне', 'думать', 'головы', 'платье', 'весело', 'сквозь', 'наташа', 'придет', 'другим', 'тысячи', 'говори', 'тяжело', 'смотря', 'громко', 'дороге', 'бывает', 'глядел', 'говоря', 'молчал', 'дорогу', 'смерти', 'солнце', 'третий', 'городе', 'думала', 'стыдно', 'читать', 'будешь', 'вечера', 'трудно', 'доктор', 'волосы', 'недели', 'ходить', 'андрей', 'прошло', 'стояла', 'должны', 'понять', 'вокруг', 'месяца', 'правду', 'никому', 'поднял', 'ногами', 'пришла', 'прощай', 'словно', 'добрый', 'старый', 'многие', 'угодно', 'штольц', 'должна', 'города', 'кстати', 'письма', 'писать', 'станет', 'видимо', 'возьми', 'пойдем', 'разные', 'смотри', 'дороги', 'слушал', 'слегка', 'кричал', 'скажет', 'поздно', 'больно', 'бросил', 'любила', 'слушай', 'уверен', 'подлец', 'сторон', 'стояли', 'твердо', 'прошел', 'сидела', 'можешь', 'постой', 'другая', 'братец', 'будете', 'неделю', 'ступай', 'видели', 'пойдет', 'делает', 'начали', 'лошадь', 'выйдет', 'боялся', 'всякой', 'смерть', 'всяком', 'играть', 'смотрю', 'явился', 'колени', 'воздух', 'просил', 'раньше', 'церкви', 'черные', 'бедный', 'принял', 'строго', 'россии', 'слышно', 'спустя', 'хотели', 'первая', 'любите', 'хозяин', 'памяти', 'первое', 'бедная', 'оттуда', 'скорей', 'восемь', 'лошади', 'скучно', 'людьми', 'отсюда', 'первой', 'сапоги', 'видела', 'диване', 'разных', 'ворота', 'второй', 'гостей', 'словах', 'чувств', 'ответа', 'сидеть', 'бежать', 'столом', 'верить', 'думает', 'страха', 'горячо', 'нового', 'бумаги', 'десяти', 'москве', 'офицер', 'близко', 'платок', 'сердцу', 'вашему', 'дверей', 'пришли', 'солнца', 'послал', 'тысячу', 'отдать', 'смысле', 'женщин', 'ожидал', 'первые', 'какими', 'голоса', 'смешно', 'федора', 'карман', 'искать', 'будьте', 'поняла', 'принес', 'притом', 'собака', 'такими', 'твоего', 'многих', 'нежели', 'кричит', 'кончил', 'старец', 'судьба', 'забыть', 'многое', 'прости', 'каждым', 'какому', 'сидели', 'всяких', 'господ', 'работу', 'каждом', 'мамаша', 'мыслей', 'уверяю', 'дочери', 'помалу', 'прошла', 'солдат', 'держал', 'хороша', 'навеки', 'издали', 'кузнец', 'пришло', 'сестра', 'ударил', 'лежала', 'старая', 'увидал', 'вторых', 'дорога', 'трудом', 'улыбка', 'высоко', 'каждое', 'узнала', 'боится', 'вскоре', 'плачет', 'старые', 'барина', 'минута', 'память', 'поехал', 'любили', 'мнение', 'начать', 'никуда', 'считал', 'двести', 'испуге', 'меньше', 'неужто', 'злобно', 'платья', 'службе', 'берегу', 'бывают', 'горько', 'делают', 'момент', 'глядит', 'камень', 'смехом', 'высшей', 'губами', 'сделаю', 'каждую', 'начало', 'открыл', 'прочим', 'службу', 'сперва', 'барыня', 'больна', 'лембке', 'всякое', 'москву', 'мужики', 'передо', 'ужасом', 'жизнью', 'встала', 'дверям', 'друзья', 'козаки', 'нашему', 'работы', 'ходила', 'бумагу', 'народа', 'прочел', 'пьяный', 'родной', 'слыхал', 'любишь', 'ходили', 'налево', 'просит', 'верите', 'обеими', 'обещал', 'собаки', 'каково', 'кресла', 'начале', 'письме', 'плакал', 'смеясь', 'шатова', 'этакой', 'местах', 'первую', 'сергей', 'стакан', 'помнил', 'поутру', 'словам', 'служил', 'старца', 'указал', 'секрет', 'думали', 'сверху', 'будучи', 'костик', 'случаю', 'умерла', 'девять', 'добрая', 'первом', 'девица', 'дивана', 'заклад', 'начнет', 'похоже', 'языком', 'глазам', 'гулять', 'забыла', 'имеете', 'мнению', 'застал', 'копеек', 'кровью', 'махнул', 'москвы', 'пальто', 'тишина', 'готова', 'заснул', 'первым', 'правой', 'садись', 'светло', 'широко', 'темные', 'узнали', 'слушаю', 'возьму', 'добрые', 'пользу', 'силами', 'успела', 'берега', 'грусть', 'дверях', 'вечеру', 'забыли', 'купить', 'небось', 'светом', 'сестры', 'шинель', 'веришь', 'всякую', 'здоров', 'князем', 'сладко', 'старой', 'узнает', 'молчит', 'полное', 'поняли', 'верхом', 'каждой', 'мрачно', 'пропал', 'упорно', 'власть', 'выпить', 'давать', 'народу', 'скажут', 'челове', 'грозно', 'святой', 'такому', 'талант', 'городу', 'кресло', 'пешком', 'прийти', 'успели', 'подать', 'полный', 'родная', 'увидит', 'улицам', 'готовы', 'наверх', 'прочее', 'родион', 'слушая', 'считаю', 'важное', 'дверью', 'достал', 'поклон', 'уселся', 'комнат', 'поводу', 'триста', 'увидев', 'андрея', 'злости', 'ильича', 'карету', 'мнения', 'прошли', 'частию', 'выходя', 'доброе', 'доселе', 'друзей', 'обязан', 'окнами', 'поедем', 'русски', 'случая', 'судить', 'черный', 'бедной', 'бывший', 'кверху', 'кивнул', 'ожидая'],
7: ['словарь', 'человек', 'наконец', 'говорит', 'говорил', 'сказать', 'никогда', 'кажется', 'впрочем', 'который', 'конечно', 'спросил', 'сказала', 'которые', 'сегодня', 'отвечал', 'слишком', 'сколько', 'обломов', 'заметил', 'которой', 'стороны', 'образом', 'говорят', 'подумал', 'немного', 'глазами', 'господа', 'которая', 'пожалуй', 'генерал', 'которых', 'времени', 'которую', 'дядюшка', 'крайней', 'комнате', 'сделать', 'нарочно', 'комнату', 'неужели', 'понимаю', 'молодой', 'смотрел', 'голосом', 'головой', 'главное', 'сначала', 'господи', 'странно', 'котором', 'ромашов', 'которое', 'другого', 'сторону', 'комнаты', 'большой', 'женщина', 'николай', 'крикнул', 'батюшка', 'ответил', 'вечером', 'столько', 'которым', 'страшно', 'дескать', 'наверно', 'первого', 'виноват', 'чичиков', 'однажды', 'матушка', 'скажите', 'подошел', 'варвара', 'думаете', 'всякого', 'счастье', 'решился', 'приехал', 'мальчик', 'степени', 'слезами', 'гораздо', 'чувства', 'алексей', 'улыбкой', 'чувство', 'капитан', 'сказали', 'женщины', 'старуха', 'хочется', 'дмитрий', 'постели', 'радости', 'хозяйка', 'остался', 'следует', 'схватил', 'ребенок', 'никакой', 'смотрит', 'просить', 'слушать', 'выходит', 'думаешь', 'положил', 'лебедев', 'счастья', 'бабушка', 'глубоко', 'старика', 'получил', 'сильнее', 'радость', 'никаких', 'отчасти', 'перебил', 'маточка', 'вскочил', 'понимал', 'девушка', 'написал', 'сердцем', 'принять', 'впереди', 'грустно', 'взгляда', 'девочка', 'лошадей', 'вопросы', 'шепотом', 'некогда', 'дорогой', 'приятно', 'стороне', 'холодно', 'болезни', 'сказано', 'постель', 'история', 'недавно', 'дедушка', 'рогожин', 'степана', 'заранее', 'объявил', 'головою', 'русский', 'помнишь', 'церковь', 'аркадий', 'большая', 'побежал', 'начинал', 'сделали', 'положим', 'ребенка', 'словами', 'плакала', 'другому', 'оставил', 'большие', 'большим', 'ипполит', 'полчаса', 'глядеть', 'надобно', 'плечами', 'помните', 'историю', 'пальцем', 'деревне', 'оцените', 'липутин', 'слышите', 'причины', 'пройдет', 'господь', 'евгений', 'сделала', 'желание', 'любовью', 'природы', 'слышишь', 'плакать', 'хороший', 'кровати', 'надеюсь', 'истории', 'изредка', 'показал', 'деревню', 'ласково', 'увидишь', 'доволен', 'слышали', 'смеялся', 'великий', 'клянусь', 'астафий', 'случаях', 'обедать', 'страсти', 'направо', 'совести', 'старого', 'темноте', 'кармана', 'матерью', 'николая', 'рассказ', 'надежда', 'очередь', 'неловко', 'отлично', 'потерял', 'болезнь', 'большую', 'женщину', 'больной', 'воздухе', 'комната', 'ордынов', 'простой', 'предмет', 'русских', 'увидите', 'границу', 'минутку', 'обратно', 'слышала', 'спасибо', 'федорыч', 'слушала', 'слышать', 'досадой', 'надежды', 'замечал', 'русской', 'повести', 'подошла', 'высокий', 'каждого', 'коленях', 'страсть', 'удалось', 'возьмет', 'дворник', 'милости', 'молчать', 'прервал', 'философ', 'взгляде', 'глядела', 'отворил', 'русские', 'молодые', 'порядок', 'услышал', 'барышня', 'больших', 'которою', 'полноте', 'смеется', 'терпеть', 'другими', 'молодых', 'вопроса', 'молчала', 'наталья', 'помещик', 'доктора', 'очнулся', 'служить', 'считать', 'дыхание', 'заметив', 'захотел', 'портрет', 'хозяина', 'четырех', 'большое', 'боялась', 'платком', 'кончено', 'бедного', 'офицера', 'сохрани', 'умереть', 'бледный', 'выдумал', 'держать', 'дмитрия', 'доброго', 'записку', 'кабинет', 'повесть', 'сделает', 'всякому', 'девушки', 'длинные', 'ракитин', 'солдаты', 'деревни', 'детства', 'кричали', 'поручик', 'убежден', 'участие', 'явление', 'большею', 'послать', 'пустяки', 'влюблен', 'зеркало', 'опустил', 'восторг', 'заметно', 'милость', 'отвечаю', 'самовар', 'уверены', 'женился', 'подняла', 'просила', 'ноздрев', 'полтора', 'бросила', 'крыльцо', 'молодая', 'мужчины', 'сделано', 'черными', 'авдотья', 'бояться', 'выходил', 'кончить', 'кричала', 'впервые', 'глядели', 'месяцев', 'подушку', 'позабыл', 'покорно', 'пушкина', 'страхом', 'супруга', 'покойно', 'понимая', 'природа', 'скажешь', 'бумажку', 'гаврила', 'длинный', 'евгения', 'русская', 'кричать', 'крыльца', 'наскоро', 'поражен', 'станции', 'француз', 'захочет', 'открыть', 'прежнее', 'вздохом', 'кровать', 'офицеры', 'старухи', 'сумерки', 'тетушка', 'кармане', 'кулаком', 'приедет', 'секунду', 'картины'],
8: ['говорить', 'человека', 'довольно', 'господин', 'особенно', 'казалось', 'иванович', 'которого', 'говорила', 'например', 'несмотря', 'спросила', 'говорили', 'вскричал', 'павлович', 'напротив', 'петрович', 'прибавил', 'двадцать', 'хотелось', 'ивановна', 'голядкин', 'отвечала', 'известно', 'закричал', 'смотреть', 'говорите', 'петровна', 'лизавета', 'разговор', 'произнес', 'вероятно', 'бросился', 'катерина', 'серьезно', 'взглядом', 'медленно', 'никакого', 'человеку', 'прощайте', 'взглянул', 'извините', 'спросить', 'смотрела', 'маменька', 'сударыня', 'государь', 'которому', 'вспомнил', 'квартиру', 'голубчик', 'очевидно', 'отвечает', 'сомнения', 'настасья', 'повторил', 'напрасно', 'заметила', 'спокойно', 'послушай', 'генерала', 'поскорее', 'смотрите', 'невольно', 'покамест', 'здоровье', 'говоришь', 'григорий', 'внимание', 'заметить', 'поглядел', 'внезапно', 'счастлив', 'странное', 'отвечать', 'чувствую', 'внимания', 'простите', 'третьего', 'характер', 'оставить', 'павловна', 'тридцать', 'делается', 'немножко', 'показать', 'поспешно', 'встретил', 'обломова', 'приходил', 'наденька', 'лестнице', 'навсегда', 'чувством', 'осталось', 'раздался', 'крестьян', 'чиновник', 'жениться', 'извольте', 'ответила', 'которыми', 'обществе', 'нехорошо', 'общества', 'слушайте', 'молчание', 'поднялся', 'стараясь', 'искренно', 'волнении', 'смеяться', 'старался', 'подумать', 'кириллов', 'возможно', 'заключил', 'прежнему', 'поскорей', 'расскажу', 'глупости', 'ивановны', 'порфирий', 'касается', 'радостно', 'нравится', 'движение', 'двадцати', 'волнения', 'остались', 'молодого', 'протянул', 'квартире', 'общество', 'свидания', 'осталась', 'квартиры', 'смотрели', 'согласен', 'замолчал', 'заметили', 'существо', 'поставил', 'движения', 'отчаянии', 'написано', 'половину', 'пришлось', 'вздохнул', 'губернии', 'остается', 'лестницы', 'удивился', 'повторяю', 'понимает', 'изволили', 'мальчика', 'понимать', 'приказал', 'странный', 'афанасий', 'старушка', 'улыбаясь', 'восторге', 'посмотри', 'тихонько', 'временем', 'изволите', 'перестал', 'прокурор', 'возьмите', 'лестницу', 'ожидании', 'страшный', 'аграфена', 'целовать', 'бормотал', 'катерины', 'оставьте', 'остаться', 'половина', 'виновата', 'неправда', 'приехали', 'простить', 'странным', 'чувствуя', 'деньгами', 'крикнула', 'начинает', 'пальцами', 'русского', 'принялся', 'пустился', 'знакомый', 'нечаянно', 'указывая', 'ивановне', 'пойдемте', 'поразило', 'ромашова', 'четверть', 'варенька', 'восторга', 'приходит', 'схватила', 'видимому', 'волнение', 'случайно', 'странная', 'ступайте', 'известие', 'подумала', 'прежнего', 'прощения', 'передать', 'передней', 'глупость', 'накануне', 'знакомых', 'написать', 'сделался', 'старичок', 'высокого', 'попросил', 'совестно', 'сущности', 'наверное', 'началось', 'небрежно', 'поверьте', 'решилась', 'сообщить', 'хорошего', 'возразил', 'гордость', 'страшная', 'половины', 'радостью', 'сделайте', 'лебедева', 'очутился', 'петровны', 'повторял', 'рассказа', 'садитесь', 'мысленно', 'праздник', 'квартира', 'офицеров', 'подобных', 'помолчав', 'сознание', 'улыбался', 'художник', 'маврикий', 'придется', 'работать', 'смеялись', 'взглянув', 'ощущение', 'приятель', 'недалеко', 'оставили', 'странные', 'генералу', 'прочесть', 'тридцати', 'цыпочках', 'капитана', 'поступок', 'советник', 'временам', 'выдержал', 'объяснил', 'уважение', 'кончится', 'начинала', 'приехала', 'большими', 'большого', 'волосами', 'ивановну', 'началась', 'побежала'],
9: ['несколько', 'александр', 'продолжал', 'федорович', 'позвольте', 'случилось', 'господина', 'посмотрел', 'мгновение', 'последний', 'последнее', 'признаюсь', 'человеком', 'хлестаков', 'понимаете', 'голядкина', 'некоторые', 'заговорил', 'бросилась', 'последние', 'рассказал', 'разумихин', 'андреевна', 'состоянии', 'воротился', 'прибавила', 'петербург', 'маленький', 'полковник', 'ивановича', 'обратился', 'обращаясь', 'улыбнулся', 'прекрасно', 'павловича', 'засмеялся', 'смердяков', 'благодарю', 'положение', 'поминутно', 'выражение', 'грушенька', 'пятьдесят', 'положении', 'настенька', 'понимаешь', 'прошептал', 'торопливо', 'оказалось', 'помилуйте', 'вздрогнул', 'антонович', 'некоторое', 'осторожно', 'подхватил', 'закричала', 'последней', 'постоянно', 'вскричала', 'вскрикнул', 'пульхерия', 'произошло', 'случалось', 'задумался', 'покраснел', 'маленькая', 'навстречу', 'некоторым', 'тарантьев', 'взглянула', 'поцеловал', 'догадался', 'ставрогин', 'спрашивал', 'проснулся', 'спрашиваю', 'задумчиво', 'испугался', 'останется', 'сделалось', 'взглянуть', 'объяснить', 'множество', 'разговора', 'нисколько', 'показался', 'маленькие', 'отозвался', 'характера', 'некоторых', 'кончилось', 'господину', 'следовало', 'петровича', 'красавица', 'настоящий', 'находился', 'обернулся', 'принимать', 'мгновенно', 'состояние', 'рассеянно', 'семейства', 'сердитесь', 'мальчишка', 'остановил', 'небольшой', 'незаметно', 'заплакала', 'задыхаясь', 'любопытно', 'малейшего', 'отношения', 'последних', 'последнюю', 'поставить', 'намерение', 'семеновна', 'поднялась', 'самолюбие', 'карамазов', 'некотором', 'побледнел', 'чувствует', 'восторгом', 'маленькую', 'матвеевна', 'оставался', 'отрывисто', 'молодости', 'неприятно'],
10: ['совершенно', 'непременно', 'разумеется', 'проговорил', 'решительно', 'показалось', 'степанович', 'чувствовал', 'александра', 'немедленно', 'пристально', 'трофимович', 'пожалуйста', 'невозможно', 'воскликнул', 'петербурге', 'городничий', 'удивлением', 'рассказать', 'милостивый', 'продолжала', 'послушайте', 'неожиданно', 'посмотреть', 'михайловна', 'посмотрела', 'неизвестно', 'платоновна', 'собственно', 'отправился', 'пятнадцать', 'вскрикнула', 'усмехнулся', 'посмотрите', 'последнего', 'повернулся', 'согласился', 'федоровича', 'неподвижно', 'николаевич', 'хорошенько', 'генеральша', 'продолжать', 'двенадцать', 'алексеевич', 'поговорить', 'поклонился', 'вчерашнего', 'филиппович', 'неприятеля', 'вследствие', 'оставаться', 'потихоньку', 'оставалось', 'становится', 'недоумении', 'откровенно', 'послышался', 'спрашивать', 'необходимо', 'прекрасное', 'прошептала', 'называется', 'признаться', 'петербурга', 'улыбнулась', 'заговорила', 'особенного', 'равнодушно', 'засмеялась', 'изумлением', 'николаевна', 'показалась', 'александру', 'прекрасный', 'спрашивает', 'выражением', 'отношениях', 'захотелось', 'происходит', 'вполголоса', 'здравствуй', 'начальство', 'отворилась', 'покраснела', 'филипповна', 'некоторого', 'обратилась', 'подпоручик', 'поцеловала'],
11: ['чрезвычайно', 'остановился', 'вельчанинов', 'обыкновенно', 'проговорила', 'единственно', 'пробормотал', 'представить', 'впечатление', 'прокофьевна', 'обыкновению', 'рассказывал', 'внимательно', 'нетерпением', 'возможности', 'удивительно', 'становилось', 'подробности', 'никифорович', 'беспрерывно', 'представьте', 'согласитесь', 'продолжение', 'сумасшедший', 'воскликнула', 'трофимовича', 'происходило', 'предложение', 'нетерпеливо', 'справедливо', 'обрадовался', 'послезавтра', 'собственной', 'почтительно', 'любопытство', 'исступлении', 'наслаждение', 'рассердился', 'благородный', 'значительно'],
12: ['раскольников', 'почувствовал', 'окончательно', 'любопытством', 'всеволодович', 'рассказывать', 'остановилась', 'беспокойтесь', 'впоследствии', 'свидригайлов', 'удовольствие', 'удовольствия', 'торжественно', 'преступление', 'наслаждением', 'воспоминания', 'положительно', 'достоинством', 'беспрестанно', 'здравствуйте', 'остановились'],
    };
});
...
ig.module('game.main').requires('impact.game', 'impact.font', 'game.menus.about', 'game.menus.game-over', 'game.menus.pause', 'game.menus.title', 'game.entities.enemy-missle', 'game.entities.enemy-mine', 'game.entities.enemy-destroyer', 'game.entities.enemy-oppressor', 'game.entities.player', 'game.keyboard', 'game.xhr', 'game.ease', 'plugins.silent-loader', 'plugins.rise-loader', 'game.document-scanner', 'game.words.en').defines(function() {
    ...
    /*if (xmtrue) {
        ...
        ig.doc = new ig.DocumentScanner(doc);
        if (!ig.ua.mobile) {
